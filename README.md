...
I build modern, high-performance web applications using the **VILT stack** (Vue, Inertia, Laravel, Tailwind). I'm passionate about clean code, type-safety with **TypeScript**, and creating beautiful user interfaces with **shadcn/ui**.
